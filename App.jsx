...
const ALL_PERIODS = [
  ...
  { id: 'p52', start: '2026-07-31', end: '2026-08-02', label: 'vendredi 31 juillet au dimanche 2 aout 2026', monthKey: '2026-07' },
  { id: 'p53', start: '2026-08-02', end: '2026-08-04', label: 'dimanche 2 aout au mardi 4 aout 2026', monthKey: '2026-08' },
  { id: 'p54', start: '2026-08-04', end: '2026-08-06', label: 'mardi 4 aout au jeudi 6 aout 2026', monthKey: '2026-08' },
  { id: 'p55', start: '2026-08-06', end: '2026-08-08', label: 'jeudi 6 aout au samedi 8 aout 2026', monthKey: '2026-08' },
  { id: 'p56', start: '2026-08-08', end: '2026-08-10', label: 'samedi 8 aout au lundi 10 aout 2026', monthKey: '2026-08' },
  { id: 'p57', start: '2026-08-10', end: '2026-08-12', label: 'lundi 10 aout au mercredi 12 aout 2026', monthKey: '2026-08' },
  { id: 'p58', start: '2026-08-12', end: '2026-08-14', label: 'mercredi 12 aout au vendredi 14 aout 2026', monthKey: '2026-08' },
  { id: 'p59', start: '2026-08-14', end: '2026-08-16', label: 'vendredi 14 aout au dimanche 16 aout 2026', monthKey: '2026-08' },
  { id: 'p60', start: '2026-08-16', end: '2026-08-18', label: 'dimanche 16 aout au mardi 18 aout 2026', monthKey: '2026-08' },
  { id: 'p61', start: '2026-08-18', end: '2026-08-20', label: 'mardi 18 aout au jeudi 20 aout 2026', monthKey: '2026-08' },
  { id: 'p62', start: '2026-08-20', end: '2026-08-22', label: 'jeudi 20 aout au samedi 22 aout 2026', monthKey: '2026-08' },
  { id: 'p63', start: '2026-08-22', end: '2026-08-24', label: 'samedi 22 aout au lundi 24 aout 2026', monthKey: '2026-08' },
  { id: 'p64', start: '2026-08-24', end: '2026-08-26', label: 'lundi 24 aout au mercredi 26 aout 2026', monthKey: '2026-08' },
  { id: 'p65', start: '2026-08-26', end: '2026-08-28', label: 'mercredi 26 aout au vendredi 28 aout 2026', monthKey: '2026-08' },
  { id: 'p66', start: '2026-08-28', end: '2026-08-30', label: 'vendredi 28 aout au dimanche 30 aout 2026', monthKey: '2026-08' },
  { id: 'p67', start: '2026-08-30', end: '2026-09-01', label: 'dimanche 30 aout au mardi 1 septembre 2026', monthKey: '2026-08' },
  ...
  { id: 'p106', start: '2026-11-16', end: '2026-11-18', label: 'lundi 16 novembre au mercredi 18 novembre 2026', monthKey: '2026-11' },
  { id: 'p107', start: '2026-11-18', end: '2026-11-20', label: 'mercredi 18 novembre au vendredi 20 novembre 2026', monthKey: '2026-11' },
];
const MONTHS_META = [
...
function RappelModal({ eng, onClose }) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('engagements_joj');
    if (saved) setEngagements(JSON.parse(saved));
  }, []);

  function saveAll(list) {
    setEngagements(list);
    localStorage.setItem('engagements_joj', JSON.stringify(list));
  }
  ...
  function confirmRapport({ heures, minutes, temoignage }) {
          ...
          <div style={S.card}>
            ...
            <div style={S.section}>
              ...
              <Fld label="Telephone *" err={errors.telephone}>
                <input style={{...S.inp,...(errors.telephone?S.inpErr:{})}} placeholder="ex : +221 77 123 45 67" value={form.telephone} inputMode="tel" onChange={e => handleChange('telephone', e.target.value)} />
              </Fld>
            </div>
            ...
            <div style={S.section}>
              ...
              <div style={S.moisTitre}>
                CHAINE DE JEUNE JOJ DAKAR 2026 - {(MONTHS_META.find(m => m.key===activeMois)?.label || '').toUpperCase()}
              ...
              : liste.slice().reverse().map(eng => {
                  ...
                  return (
                    <div key={eng.id} style={S.engCard}>
                      ...
                      {eng.rapport && (
                        <div style={S.rapBox}>
                          <strong>Compte-rendu :</strong> {eng.rapport.heures}h{String(eng.rapport.minutes).padStart(2,'0')} · {eng.rapport.date}
                      ...
                      <div style={{display:'flex',gap:8,marginTop:10,flexWrap:'wrap'}}>
                        ...
                        <button style={S.btnRappel} onClick={() => setRappel(eng)}>🔔 Rappel</button>
                      </div>
                    </div>
                  );
                })
              ...
              {MONTHS_META.map(m => {
                ...
                return (
                  <div key={m.key} style={S.moisRow}>
                    ...
                    <span style={S.moisCnt}>{tak}/{tot} · {pct}%</span>
                  </div>
                );
              })}
            </div>
            <div style={S.card}>
              <h3 style={S.cardT}>Grille des periodes</h3>
